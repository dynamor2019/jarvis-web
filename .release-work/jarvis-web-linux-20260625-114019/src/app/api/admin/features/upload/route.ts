...
import { ensureStorePluginTable as ensureStorePluginTableWithLocale, getStorePluginLocalization } from '@/lib/storePluginLocale';
...
export async function POST(request: NextRequest) {
  try {
    ...
    await prisma.$executeRaw`
      INSERT INTO "StorePlugin" ("id", "name", "nameZh", "nameEn", "version", "price", "description", "descriptionZh", "descriptionEn", "fileName", "updatedAt")
      VALUES (${pluginId}, ${localized.nameZh}, ${localized.nameZh}, ${localized.nameEn}, ${version}, ${price}, ${localized.descriptionZh}, ${localized.descriptionZh}, ${localized.descriptionEn}, ${finalName}, CURRENT_TIMESTAMP)
