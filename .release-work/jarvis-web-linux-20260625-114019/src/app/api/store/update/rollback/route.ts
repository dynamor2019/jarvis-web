...
import { releaseFiles, buildRollback } from '@/lib/updateRepo'
...
export async function GET(req: Request) {
  try {
    ...
    const patches = buildRollback(toFiles, fromFiles)
    const patch = { plugin_id: meta.pluginId, from: toV, to: fromV, patches }
