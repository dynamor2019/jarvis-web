                                    ...
                                    <thead className="bg-gray-50">
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.user" defaultMessage="用户" />
                                            </th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.time" defaultMessage="时间" />
                                            </th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.type" defaultMessage="类型" />
                                            </th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.description" defaultMessage="描述" />
                                            </th>
                                            <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.amount" defaultMessage="金额" />
                                            </th>
                                            <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.balance" defaultMessage="余额" />
                                            </th>
                                            <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="admin.transactions.table.status" defaultMessage="状态" />
                                            </th>
                                        </tr>
                                    </thead>
