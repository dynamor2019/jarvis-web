                                    ...
                                    <thead className="bg-gray-50">
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="transactions.col.time" defaultMessage="时间" />
                                            </th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="transactions.col.type" defaultMessage="类型" />
                                            </th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="transactions.col.desc" defaultMessage="描述" />
                                            </th>
                                            <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="transactions.col.amount" defaultMessage="金额" />
                                            </th>
                                            <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="transactions.col.balance" defaultMessage="余额" />
                                            </th>
                                            <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                <FormattedMessage id="transactions.col.status" defaultMessage="状态" />
                                            </th>
                                        </tr>
                                    </thead>
