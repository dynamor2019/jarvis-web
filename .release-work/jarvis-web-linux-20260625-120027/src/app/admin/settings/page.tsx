...
// - locale -> line 114
// - handleInstallerUpload -> line 206
// - handleSubmit -> line 248
// - handleRemoveCustomModel -> line 286
// - uploadFeaturePackage -> line 313
// - handleReplacePublishedPlugin -> line 391
// - handleEditPublishedPlugin -> line 410
// - handleSaveFeatureInfo -> line 435
// [/CodeGuard Feature Index]
...
export default function AdminSettingsPage() {
    ...
    const fetchPublishedPlugins = useCallback(async () => {
        try {
            ...
            const response = await fetch(`/api/store/plugins?locale=${encodeURIComponent(locale)}`);
                        ...
                        {activeTab === 'payment' && (
                            <div className="space-y-8">
                                ...
                                <div className="border-t pt-6">
                                    ...
                                    <div className="grid gap-4">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">开放平台 App ID</label>
                                            <input
                                                type="text"
                                                name="wechat_app_id"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">支付绑定 App ID</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                name="wechat_api_key_v3"
                                                value={settings.wechat_api_key_v3}
                                                onChange={handleChange}
                                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"
                                                placeholder="微信支付 API v3 32位密钥"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">微信支付公钥 ID</label>
                                            <input
                                                type="text"
                                                name="wechat_public_key_id"
                                                value={settings.wechat_public_key_id}
                                                onChange={handleChange}
                                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">商户证书路径</label>
                                            <input
                                                type="text"
                                                name="wechat_pay_cert_path"
                                                value={settings.wechat_pay_cert_path}
                                                onChange={handleChange}
                                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 font-mono text-sm"
                                                placeholder="certs/wechatpay/apiclient_cert.pem"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">商户私钥路径</label>
                                            <input
                                                type="text"
                                                name="wechat_pay_key_path"
                                                value={settings.wechat_pay_key_path}
                                                onChange={handleChange}
                                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 font-mono text-sm"
                                                placeholder="certs/wechatpay/apiclient_key.pem"
                                            />
                                        </div>
                                    </div>
                                </div>
